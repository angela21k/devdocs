...
|`RetrieveAllOptionSets`|You can retrieve information about all the global choices defined in the organization.<br />See: [Insert, update, delete, and order global choices](org-service/metadata-global-option-set-options.md)<br /><br />**Limitations**: Choices that are only defined locally within a column are not included.|
